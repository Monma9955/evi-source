...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<test-unit>.freeze, ["= 3.3.7"])
      s.add_development_dependency(%q<timecop>.freeze, ["= 0.9.2"])
      ...
      s.add_dependency(%q<test-unit>.freeze, ["= 3.3.7"])
      s.add_dependency(%q<timecop>.freeze, ["= 0.9.2"])
