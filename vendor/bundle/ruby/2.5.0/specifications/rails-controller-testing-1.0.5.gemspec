...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_dependency(%q<actionpack>.freeze, [">= 5.0.1.rc1"])
      s.add_dependency(%q<actionview>.freeze, [">= 5.0.1.rc1"])
      s.add_dependency(%q<activesupport>.freeze, [">= 5.0.1.rc1"])
      s.add_dependency(%q<railties>.freeze, [">= 5.0.1.rc1"])
